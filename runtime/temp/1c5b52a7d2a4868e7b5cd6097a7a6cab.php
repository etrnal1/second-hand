<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"C:\wamp\www\second-hand\thinkphp\public/../application/index\view\goods\search.html";i:1490361946;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="main center">
        ...
        <div class="item-list">
            <ul class="items clearfix">
                <?php if(!empty($keywords)): foreach($keywords as $shop): ?>
                ...
                <?php endforeach; else: ?>
                <li class="item_sorry">
                    <font color="black">抱歉:您所要寻找的</font> <font color="red">"<?php echo $keyword; ?>"</font> <font color="black">未找到</font>
