...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="__STATIC_URL__/amaze/css/webuploader.css">
    <link rel="stylesheet" type="text/css" href="__STATIC_URL__/amaze/css/diyUpload.css">
    <script src="jquery.js"></script>
    <script type="text/javascript" src="__STATIC_URL__/amaze/js/webuploader.html5only.min.js"></script>
    <script type="text/javascript" src="__STATIC_URL__/amaze/js/diyUpload.js"></script>
...
<div class="container">
    <div class="main center">
        <div class="neirong">
            <form action="<?php echo url('index/publish/upload'); ?>" enctype="multipart/form-data" method="post">
                ...
                <?php foreach($name as $value): ?>
                    <option value="<?php echo $value->class_id; ?>" selected="selected"><?php echo $value->class_name; ?></option>
                <?php endforeach; ?>
                </select></div>
                ...
                <br>
                <!-- <input type="submit" value="发布" class="submit1"  size="15" style="width:100px; height:50px;" /> -->
                <input type="submit" value="发布" class="submit"  size="15" style="width:100px; height:50px;" />
            </form>
...
<div class="return-to-top"><a href=""></a></div>
    ...
    <script type="text/javascript">
        $('.submit').click(function(){
            ...
            var class_name = $("select option:selected").val();
            var params = {
                name: name,
                profile: profile,
                location: location,
