<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"C:\AppServ\www\tp5\public/../application/admin\view\index\page.html";i:1490079387;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/index/index/upload"  enctype="multipart/form-data" >      
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="file" id="url1" name="image" class="input tips" style="width:25%; float:left;"  value=""  data-toggle="hover" data-place="right" data-image="" />
